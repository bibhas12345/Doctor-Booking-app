...
export default function Dental1() {
  ...
  return (
    <div className='justify-center bg-sky-900 h-[850px] items-center flex'>
      ...
      <div className='h-[200px] w-full mt-7 p-3 flex bg-sky-500'>
        <img className='h-40 w-44 mt-5 rounded-full' src='https://images.unsplash.com/photo-1612943733919-f9661f1331f5?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTIyfHxkb2N0b3J8ZW58MHx8MHx8fDA%3D' alt='/'/>
        <p className='text-2xl font-bold mt-5'>Dr.Saha| Dental Specialist</p>
        </div>
