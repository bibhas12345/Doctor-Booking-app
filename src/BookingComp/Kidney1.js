    ...
    <div className='justify-center bg-sky-900 h-full items-center flex'>
      ...
      <div className=" p-4 flex flex-col mb-9 justify-center items-center">
        <div className='h-[200px] w-full mt-7 p-3 flex bg-sky-500'>
          <img className='h-40 w-44 mt-2 rounded-full' src='https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fGRvY3RvcnxlbnwwfHwwfHx8MA%3D%3D' alt='/' />
          <div>
            <p className='text-2xl ml-3 font-bold mt-5'>Dr.Sen| Kidney Specialist</p>
