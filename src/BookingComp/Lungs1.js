...
export default function Lungs1() {
  ...
  return (
    <div className='justify-center bg-sky-900 h-[850px] items-center flex'>
      ...
      <div className='h-[200px] w-full mt-7 p-3 flex bg-sky-500'>
        <img className='h-40 w-44 mt-5 rounded-full' src='https://img.freepik.com/free-photo/handsome-smiling-medical-professional-examining-with-stethoscope-colored-background_662251-366.jpg?size=626&ext=jpg&ga=GA1.1.890975536.1709918995&semt=sph' alt='/'/>
        <p className='text-2xl font-bold mt-5'>Dr.Rohit| Lungs Specialist</p>
        </div>
