    ...
    <div className='justify-center bg-sky-900 h-full items-center flex'>
      ...
      <div className=" p-4 flex flex-col mb-9 justify-center items-center">
        <div className='h-[200px] w-full mt-7 p-3 flex bg-sky-500'>
          <img className='h-40 w-44 mt-2 rounded-full' src='https://img.freepik.com/free-photo/smiling-touching-arms-crossed-room-hospital_1134-799.jpg?size=626&ext=jpg&ga=GA1.1.890975536.1709918995&semt=sph' alt='/' />
          <div>
            <p className='text-2xl ml-3 font-bold mt-5'>Dr.Suhas| Eye Specialist</p>
