    ...
    return (
        <>
            ...
            <div className='flex flex-wrap justify-center items-center'>
                ...
                <div className='flex m-1 flex-col justify-center items-center mt-3 bg-sky-800 h-[200px] w-[180px]'>
                ...
                <div className='flex flex-col m-1 justify-center items-center mt-3 bg-sky-800 h-[200px] w-[180px]'>
                ...
                <div className='flex flex-col justify-center m-1 items-center mt-3 bg-gray-400 h-[200px] w-[180px]'>
                    ...
                    <div classNa me='flex flex-col justify-center items-center w-full'>
