  ...
  return (
    <div className='bg-gray-200 h-[100%]'>
      ...
      <div className='flex flex-col justify-center items-center w-full h-[100px]'>
        ...
        <p className='m-10 w-2/3  font-semibold text-gray-700'>choose the desire Doctor according to the problem to your door stop</p>
        <button className='flex justify-center items-center w-2/3 bg-emerald-700 px-2 p-2 rounded-full font-bold text-gray-300  ' onClick={handleLogin}>Get Started<CiLocationArrow1 className='ml-6 text-white text-2xl'/> </button>
      </div>
    </div>
  );
};
